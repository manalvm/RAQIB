...
export default function SetGooglePasswordPage() {
  ...
  // Someone landing here directly (no ticket in state) hasn't been through the
  // Google step — send them back rather than showing a form that can't succeed.
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const data = await completeGoogleSignup(ticket, form.password);
  ...
  // same simulated field-report pings used on Login/Register, for visual consistency
  const pings = [
      ...
      <div className="auth-wrap">
        ...
        <div className="card-frame">
          ...
          <div className="card" dir="rtl">
            <div className="card-eyebrow">GOOGLE_SIGNUP</div>
            <h2 className="card-title">إنشاء كلمة مرور</h2>
            <p className="card-sub">خطوة أخيرة لإكمال إنشاء حسابك عبر Google</p>
            {email && <p className="card-email">{email}</p>}
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="field">
                ...
                <input
                  ...
                  placeholder="••••••••"
                />
                <div className={`field-underline ${focused === "confirm" ? "active" : ""}`} />
              </div>
